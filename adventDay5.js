...
function computeAdvent5Part2(inp) {
    // create a copy to not modify the input
    let copyInp = Object.assign({}, inp);
    let ind = 0;
    let steps = 0;
    while (copyInp.hasOwnProperty(ind)) {
        ...
        copyInp[ind] = copyInp[ind] >= 3 ? copyInp[ind] - 1 : copyInp[ind] + 1;
        ind = ind + curVal;
        steps++;
    }
    return steps;
